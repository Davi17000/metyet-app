  ...
  return (
    <>
      ...
      <div className="nb-bar">
        ...
        {[["new", "New since last review"], ["notReviewed", "Not reviewed"], ["interested", "Interested"]]
          .map(([id, label]) => (
        ...
        <button className={"btn sm" + (demandOnly ? " on" : "")} aria-pressed={demandOnly}
          onClick={() => setDemandOnly(!demandOnly)}>Primary goal match</button>
              ...
              <div className="nb-b">
                ...
                {x.primary.length > 0 && (
                  <button className="nb-dem" aria-expanded={openDem === x.cc.id}
                    ...
                    Primary goal · {x.primary.length === 1
                      ? x.primary[0].short
                ...
                {x.primary.length === 0 && x.secondary.length > 0 && (
                  <div className="nb-dem2">Secondary goal · {x.secondary.length === 1
